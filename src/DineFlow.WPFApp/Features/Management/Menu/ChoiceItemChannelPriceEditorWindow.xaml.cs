...
public partial class ChoiceItemChannelPriceEditorWindow : Window
{
    public ChoiceItemChannelPriceEditorWindow(string choiceName, decimal basePrice, decimal currentExtraPrice, string channelName)
    {
        InitializeComponent();

        TitleText.Text = $"Lựa chọn: {choiceName}";
